...
const stack = new service.Stack("esc-sync-gcp-secret-manager", {
...
const settings = new service.DeploymentSettings("deployment_settings", {
    ...
    operationContext: {
        preRunCommands: [
            ...
            pulumi.interpolate`pulumi env open ${fullyQualifiedEnvName} sync.gcpSecretManager.value > sync.json`,
            pulumi.interpolate`pulumi config set -s ${fullyQualifiedStackName} secretName $(pulumi env open ${fullyQualifiedEnvName} sync.gcpSecretManager.name)`,
        ],
    },
});
